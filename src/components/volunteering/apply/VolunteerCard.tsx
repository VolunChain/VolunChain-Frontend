      ...
      <div className="bg-[#0F112A] p-4 sm:p-6 md:p-12 w-full rounded-[20px] sm:rounded-[30px] md:rounded-[40px]">
        <div className="flex items-center gap-3 sm:gap-4 mb-6">
          ...
          <div className="flex flex-col gap-2 flex-1">
            <h2 className="text-xl sm:text-[32px] font-semibold dark:text-white">
              {title}
            </h2>
        ...
        <div className="flex justify-start items-center gap-14 sm:gap-14 mb-6 sm:mb-8">
          <div className="flex items-center gap-3">
            <HeartIcon
              ...
              color="#EF565D"
            />
            <span className="text-sm sm:text-[24px] text-[#94A3B8]">
              {likes} Likes
            </span>
          </div>
          <div className="flex items-center gap-3">
        ...
        <div className="space-y-4 sm:space-y-6 mb-6 sm:mb-12">
          <div>
            <h3 className="text-base sm:text-[24px] font-medium dark:text-white mb-2">
              Description
            </h3>
        ...
        <div className="mb-6 sm:mb-8">
          <h3 className="text-base sm:text-[24px] font-medium dark:text-white mb-2 sm:mb-6">
            Tags
          </h3>
