  ...
  return (
    <div className="group overflow-hidden rounded-2xl md:rounded-3xl bg-[#07081f] transition-transform hover:-translate-y-1">
      ...
      <div className="p-4 md:p-6">
        <p className="mb-2 text-sm md:text-base text-[#73b9eb]">
          {companyName}
        </p>
        <h3 className="mb-3 text-xl md:text-2xl font-semibold dark:text-white">
          {title}
        </h3>
        <p className="mb-4 md:mb-6 text-sm md:text-base text-[#9d9d9d]">
          {description}
        </p>
