    ...
    return (
      <div className="flex items-center justify-center min-h-screen bg-background">
        <div className="text-center">
          ...
          <div className="text-gray-400 text-sm mt-2">Preparing the application</div>
        </div>
      </div>
    );
  }
      ...
      <div className="flex items-center justify-center min-h-screen bg-background">
        <div className="text-center max-w-md mx-auto p-6">
          ...
          <p className="text-gray-300 mb-4">
            Failed to load the language system. The application may not display text correctly.
          </p>
          ...
          <button
            ...
            className="bg-secondary hover:bg-secondary/80 text-white px-6 py-2 rounded-lg transition-colors"
          >
            Reload Application
          </button>
  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-background">
      <div className="text-center">
        ...
        <div className="text-white text-lg">Unexpected State</div>
        <div className="text-gray-400 text-sm mt-2">Please reload the application</div>
      </div>
    </div>
  );
}
