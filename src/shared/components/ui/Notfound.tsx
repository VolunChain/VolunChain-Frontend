    ...
    <div className="flex flex-col justify-between min-h-screen bg-[#07081F] dark:text-white relative">
      ...
      <div className="flex flex-col items-center flex-grow relative px-4 text-center mt-24">
        ...
        <p className="text-gray-400 mt-2 max-w-lg leading-relaxed">
          It looks like you’ve wandered off the beaten path. But don’t
          worry—there are still plenty of ways to make a difference!
        </p>
        ...
        <div className="absolute top-[20%] left-1/2 transform -translate-x-1/2 flex items-center justify-center text-[35rem] font-bold text-[#2D3248] opacity-90 select-none w-full"></div>
