...
export declare const networks: {
    readonly testnet: {
        ...
        readonly contractId: "CBIETBCJTZUDDBLZKHSFZNZV7OW5VSEPS7JVKWW6V2YFHECBBSKMMROJ";
    };
};
...
export interface Client {
     ...
     */
    create_bounty: ({ bounty_properties }: {
        bounty_properties: Bounty;
    }, options?: {
        /**
         * The fee to pay for the transaction. Default: BASE_FEE
         */
     ...
     */
    withdraw_reward: ({ volunteer, trustline }: {
        volunteer: string;
        trustline: string;
    }, options?: {
        /**
...
export declare class Client extends ContractClient {
    ...
    readonly fromJSON: {
        ...
        create_bounty: (json: string) => AssembledTransaction<Result<Bounty, import("@stellar/stellar-sdk/contract").ErrorMessage>>;
        withdraw_reward: (json: string) => AssembledTransaction<Result<Bounty, import("@stellar/stellar-sdk/contract").ErrorMessage>>;
